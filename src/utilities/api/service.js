 ...
 */
const getPriceTicker = tokenType =>
  getMappedFunction(tokenType, 'service', 'getPriceTicker')();
 ...
 */
const getDynamicFees = tokenType =>
  getMappedFunction(tokenType, 'service', 'getDynamicFees')();
