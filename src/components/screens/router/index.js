...
const darkTabs = {
  ...
  background: colors.light.headerBg,
...
const lightTabs = {
  ...
  background: colors.dark.footerBg,
  card: colors.dark.footerBg,
    ...
    <SafeAreaProvider>
      <NavigationContainer theme={themeColors}>
        <MainStack.Navigator initialRouteName="SignIn">
          <MainStack.Screen name="Register" component={Register} options={navigationOptions.Register} />
          ...
          <MainStack.Screen name="EnableBioAuth" component={EnableBioAuth} options={navigationOptions.EnableBioAuth} />
          <MainStack.Screen name="DisableBioAuth" component={DisableBioAuth} options={navigationOptions.DisableBioAuth} />
          <MainStack.Screen name="PassphraseBackup" component={PassphraseBackup} options={navigationOptions.PassphraseBackup} />
        </MainStack.Navigator>
      </NavigationContainer>
    </SafeAreaProvider>
  );
