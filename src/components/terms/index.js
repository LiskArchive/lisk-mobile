  ...
  <ScrollView style={[styles.container, styles.theme.container]}>
    <View style={styles.innerContainer}>
      <View style={styles.titleContainer}>
        <H1 style={[styles.header, styles.theme.header]}>Terms of use</H1>
        <B style={styles.theme.subTitle}>
      ...
      <View style={styles.row}>
        <H4 style={[styles.itemTitle, styles.theme.itemTitle]}>1. Scope</H4>
        <Small style={[styles.itemDescription, styles.theme.itemDescription]}>
        ...
        <H4 style={[styles.itemTitle, styles.theme.itemTitle]}>2. Eligibility and Agreement</H4>
        <Small style={[styles.itemDescription, styles.theme.itemDescription]}>
        ...
        <H4 style={[styles.itemTitle, styles.theme.itemTitle]}>3. Your Responsibilities Regarding the Use of the Services</H4>
        <Small style={[styles.itemDescription, styles.theme.itemDescription]}>
        ...
        <H4 style={[styles.itemTitle, styles.theme.itemTitle]}>4. Availability of Services</H4>
        <Small style={[styles.itemDescription, styles.theme.itemDescription]}>
        ...
        <H4 style={[styles.itemTitle, styles.theme.itemTitle]}>5. Force Majeure</H4>
        <Small style={[styles.itemDescription, styles.theme.itemDescription]}>
        ...
        <Small style={[styles.itemDescription, styles.theme.itemDescription]}>
          ...
          <H4 style={[styles.itemTitle, styles.theme.itemTitle]}>6. Public and Private Key, Passphrases</H4>
          <Small style={[styles.itemDescription, styles.theme.itemDescription]}>
          ...
          <H4 style={[styles.itemTitle, styles.theme.itemTitle]}>7. Data Protection</H4>
          <Small style={[styles.itemDescription, styles.theme.itemDescription]}>
        ...
        {'\n'}
          ...
          <H4 style={[styles.itemTitle, styles.theme.itemTitle]}>8. Prohibited Activities</H4>
          <Small style={[styles.itemDescription, styles.theme.itemDescription]}>
        ...
        {'\n'}
          ...
          <H4 style={[styles.itemTitle, styles.theme.itemTitle]}>9. Default</H4>
          <Small style={[styles.itemDescription, styles.theme.itemDescription]}>
        ...
        {'\n'}
          ...
          <H4 style={[styles.itemTitle, styles.theme.itemTitle]}>10. Indemnification</H4>
          <Small style={[styles.itemDescription, styles.theme.itemDescription]}>
          ...
          <H4 style={[styles.itemTitle, styles.theme.itemTitle]}>11. Limitation of Liability</H4>
          <Small style={[styles.itemDescription, styles.theme.itemDescription]}>
        ...
        {'\n'}
          ...
          <H4 style={[styles.itemTitle, styles.theme.itemTitle]}>12. Termination</H4>
          <Small style={[styles.itemDescription, styles.theme.itemDescription]}>
          ...
          <H4 style={[styles.itemTitle, styles.theme.itemTitle]}>13. Taxation</H4>
          <Small style={[styles.itemDescription, styles.theme.itemDescription]}>
        ...
        {'\n'}
          ...
          <H4 style={[styles.itemTitle, styles.theme.itemTitle]}>14. Entire Agreement</H4>
          <Small style={[styles.itemDescription, styles.theme.itemDescription]}>
          ...
          <H4 style={[styles.itemTitle, styles.theme.itemTitle]}>15. Severability</H4>
          <Small style={[styles.itemDescription, styles.theme.itemDescription]}>
          ...
          <H4 style={[styles.itemTitle, styles.theme.itemTitle]}>16. Changes to These Terms</H4>
          <Small style={[styles.itemDescription, styles.theme.itemDescription]}>
          ...
          <H4 style={[styles.itemTitle, styles.theme.itemTitle]}>17. Communications and Written Notices</H4>
          <Small style={[styles.itemDescription, styles.theme.itemDescription]}>
        ...
        {'\n'}
          ...
          <H4 style={[styles.itemTitle, styles.theme.itemTitle]}>18. Complaints and Disputes</H4>
          <Small style={[styles.itemDescription, styles.theme.itemDescription]}>
        {'\n'}
        ...
        {'\n'}
          ...
          <H4 style={[styles.itemTitle, styles.theme.itemTitle]}>19. Dispute Resolution, Place of Jurisdiction and Governing Law</H4>
          <Small style={[styles.itemDescription, styles.theme.itemDescription]}>
